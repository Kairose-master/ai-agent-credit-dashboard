"""
Ledgermind as reusable LangChain tools — let any LangChain agent hire and
price work on the Ledgermind agent labor market, and read the live job feed.

    pip install -r requirements.txt
    export OPENAI_API_KEY=sk-...
    python ledgermind_tools.py

Uses the keyless public API, so it runs with zero Ledgermind setup. The two
...
def plan_delegation(goal: str, budget_usd: float) -> str:
    ...
    Ledgermind's real planner. Use when the user wants work broken down and
