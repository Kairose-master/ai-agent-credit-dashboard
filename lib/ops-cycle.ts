...
export const OPS_STEPS: OpsStep[] = [
  ...
  },
  {
    ...
    // and nothing scheduled to notice. It costs a GitHub call per
    // live bounty. Fast anyway — the file's own definition of fast is "escrow
    // that should have been freed", and this is exactly that. The cost is
